...
import com.router1011.atimemod2.blocks.BlockBase;
...
public class WorldGen implements IWorldGenerator {
	...
	private void generateOre(BlockBase ore, World world, Random random, int x, int z, int minY, int maxY, int size, int chances) {
