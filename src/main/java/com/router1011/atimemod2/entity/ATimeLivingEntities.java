...
import com.router1011.atimemod2.render.living.RenderPeppermintZombie;
...
public class ATimeLivingEntities {
	...
	public static void initLivingEntites() {
		...
		new EasyLivingEntity(EntityPeppermintZombie.class, RenderPeppermintZombie.class, "PeppermintZombie", 0, 0);
