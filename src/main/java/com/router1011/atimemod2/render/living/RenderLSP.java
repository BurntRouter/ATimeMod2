...
public class RenderLSP extends RenderLiving {
	public static final ResourceLocation TEXTURE = new EntityTextureLocation(ATimeMod.MODID, "LSP");

	public RenderLSP(RenderManager manager) {
		super(manager, new ModelLSP(), 0.5F);
	}
