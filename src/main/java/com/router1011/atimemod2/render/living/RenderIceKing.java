...
import com.router1011.atimemod2.models.ModelIceKing;
...
public class RenderIceKing extends RenderLiving {
	public static final ResourceLocation TEXTURE = new EntityTextureLocation(ATimeMod.MODID, "IceKing");

	public RenderIceKing(RenderManager manager) {
		super(manager, new ModelIceKing(), 0.5F);
	}
