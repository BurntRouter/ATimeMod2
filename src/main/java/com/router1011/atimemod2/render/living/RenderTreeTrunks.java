...
public class RenderTreeTrunks extends RenderLiving {
	public static final ResourceLocation TEXTURE = new EntityTextureLocation(ATimeMod.MODID, "TreeTrunks");

	public RenderTreeTrunks(RenderManager manager) {
		super(manager, new ModelTreeTrunks(), 0.5F);
	}
