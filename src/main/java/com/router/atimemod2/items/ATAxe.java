...
public class ATAxe extends ItemTool {
    ...
    public ATAxe(IItemTier tier, float damage, float attackSpeedIn, Item.Properties builder) {
        super(damage, attackSpeedIn, tier, EFFECTIVE_ON, builder.addToolType(net.minecraftforge.common.ToolType.AXE, tier.getHarvestLevel()));
    }
