...
public class BlockFlowingFluid extends Block implements IBucketPickupHandler {
    ...
    public BlockFlowingFluid(FlowingFluid fluidIn, Block.Properties builder) {
        super(builder);
        this.fluid = fluidIn;
     ...
     * @deprecated call via {link IBlockStategetBlockFaceShape(IBlockAccess,BlockPos,EnumFacing)} whenever possible.
