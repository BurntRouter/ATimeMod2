...
import com.router.atimemod2.init.ModBlocks;
...
public abstract class JuiceBlock extends FlowingFluid {
    ...
    /**
     * Gets the render layer this block will render on. SOLID for solid block, CUTOUT or CUTOUT_MIPPED for on-off
    ...
    public IBlockState getBlockState(IFluidState state) {
        return ModBlocks.juice.getDefaultState().with(BlockFlowingFluid.LEVEL, Integer.valueOf(getLevelFromState(state)));
    }
    ...
    public static class Flowing extends JuiceBlock {
    ...
    public static class Source extends JuiceBlock {
        public int getLevel(IFluidState p_207192_1_) {
            return 8;
        }
