...
public class ModBlocks {
	...
	public static final Block JUICE = new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.YELLOW).hardnessAndResistance(1.0F).sound(SoundType.STONE).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool()).setRegistryName("juice");
